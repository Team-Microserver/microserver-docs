...
!!! tip "프로젝트 로컬 개발환경 전체 기준"
    ...
    **[프로젝트 로컬 개발환경 구성](../local_environment_setup.md)**
...
**[Windows JDK 설치 및 검증](jdk/windows_jdk_setup.md)**
...
**[macOS JDK 설치 및 검증](jdk/macos_jdk_setup.md)**

!!! note "macOS JDK 보관 경로"
    현재 `C:\local-microserver` 표준은 Windows 개발환경의 기준 Root로 정의되어 있다.
...
**[JDK 운영 및 문제 해결](jdk/jdk_management_troubleshooting.md)**

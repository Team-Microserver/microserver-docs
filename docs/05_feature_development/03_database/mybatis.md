...
- [리소스 / 설정 관리 아키텍처](../01_framework_configuration/resource_configuration_architecture.md)
- [module-common 구성](../../04_multi_project_transition/03_framework_modules/module_common.md)
- [Spring Boot YAML 공통 설정](../01_framework_configuration/spring_boot_configuration.md)

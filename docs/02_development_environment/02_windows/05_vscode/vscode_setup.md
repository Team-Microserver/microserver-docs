...
flowchart LR
    ...
    B --> C[Gradle 기본 환경]
    C --> D[VS Code 설치]
    D --> P[VS Code Portable 설정]
    P --> U[VS Code User Settings]
    U --> E[Java Extension 구성]
...
flowchart LR
    ...
    subgraph VSCODE["VS Code 개발환경 구성"]
        ...
        VS1 --> VSP --> VSU --> VS2 --> VS3 --> VS4 --> VS5 --> VS6
    end
...
### 4.1 VS Code 설치 / Portable 설정 / User Settings
